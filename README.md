...
- Application development: [JavaScript](https://en.wikipedia.org/wiki/JavaScript), [TypeScript](https://www.typescriptlang.org/), [Python](https://www.python.org), [Flask](http://flask.pocoo.org), [PHP](https://php.net), [HTML](https://developer.mozilla.org/en-US/docs/Web/HTML), [CSS](https://developer.mozilla.org/en-US/docs/Web/CSS), [Lightning Web Components](https://developer.salesforce.com/docs/component-library/documentation/en/lwc), [Apex](https://developer.salesforce.com/docs/atlas.en-us.apexcode.meta/apexcode/apex_intro.htm)/[Java](https://en.wikipedia.org/wiki/Java_(programming_language))
- Statistical modeling: regression and trend fitting with [pandas](https://pandas.pydata.org) and [NumPy](https://numpy.org) in production to predict future prices for a multi-location wireless retailer (2019); statistical analysis of survey results for a separate client
